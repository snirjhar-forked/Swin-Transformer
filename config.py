...
# Swin_S Transformer parameters
_C.MODEL.SWIN_S = CN()
_C.MODEL.SWIN_S.PATCH_SIZE = 4
_C.MODEL.SWIN_S.IN_CHANS = 3
_C.MODEL.SWIN_S.EMBED_DIM = 96
_C.MODEL.SWIN_S.DEPTHS = [2, 2, 6, 2]
_C.MODEL.SWIN_S.NUM_HEADS = [3, 6, 12, 24]
_C.MODEL.SWIN_S.WINDOW_SIZE = 7
_C.MODEL.SWIN_S.MLP_RATIO = 4.
_C.MODEL.SWIN_S.QKV_BIAS = True
_C.MODEL.SWIN_S.QK_SCALE = None
_C.MODEL.SWIN_S.APE = False
_C.MODEL.SWIN_S.PATCH_NORM = True
_C.MODEL.SWIN_S.STD = '0.5'
_C.MODEL.SWIN_S.SPLIT_KV = 'False'

# Swin Gated
# Swin Transformer parameters
_C.MODEL.SWIN_G = CN()
_C.MODEL.SWIN_G.PATCH_SIZE = 4
_C.MODEL.SWIN_G.IN_CHANS = 3
_C.MODEL.SWIN_G.EMBED_DIM = 96
_C.MODEL.SWIN_G.DEPTHS = [2, 2, 6, 2]
_C.MODEL.SWIN_G.NUM_HEADS = [3, 6, 12, 24]
_C.MODEL.SWIN_G.WINDOW_SIZE = 7
_C.MODEL.SWIN_G.MLP_RATIO = 4.
_C.MODEL.SWIN_G.QKV_BIAS = True
_C.MODEL.SWIN_G.QK_SCALE = None
_C.MODEL.SWIN_G.APE = False
_C.MODEL.SWIN_G.PATCH_NORM = True
_C.MODEL.SWIN_G.TOKEN_DROP_MAX = [0.]
_C.MODEL.SWIN_G.TOKEN_DROP_MIN = [0.]
_C.MODEL.SWIN_G.TOKEN_DROP_PATTERN = 'lin_steps'
